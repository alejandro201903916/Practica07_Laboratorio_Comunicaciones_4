...
def AnalisisFrecuencia(x, fs=16000):
    """
    Applies bandpass filters to a given signal x and returns the filtered signals along with energy and percentage calculations.
    ...
    Returns:
        ...
        yfinal (numpy array): final filtered signal
        porcentajes (numpy array): energy percentages for different frequency bands
    """
    if fs is None:
    ...
    wav.write('yfinal.wav', fs, yfinal)
